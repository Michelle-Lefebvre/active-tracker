    ...
    <div v-if="dataLoaded">
      ...
      <div class="relative flex flex-col items-center p-8 rounded-md shadow-md bg-light-grey">
        ...
        <div class="w-full mt-6">
          ...
          />
          <h1 v-else class="text-2xl text-center text-at-light-green">{{ data.workoutName }}</h1>
        </div>
      </div>

      <!-- Exercises -->
      <div class="flex flex-col p-8 mt-10 rounded-md shadow-md item-center bg-light-grey">
        <!-- Strength Training -->
